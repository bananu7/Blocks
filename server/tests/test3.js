exports.test = [
    ...
    },
    {
        ...
        objects: [
            { kind: "input", id: 1, type: "string" },
            { kind: "input", id: 2, type: "string" },
            { kind: "block", id: 3, fname: "duplicate" },
            { kind: "output", id: 4, type: "string" }
        ],
        connections: [
            { id: 1, sourceId: 1, sourceEndpoint: 1, targetId: 3, targetEndpoint: 1 },
            { id: 2, sourceId: 2, sourceEndpoint: 1, targetId: 3, targetEndpoint: 2 },
            { id: 3, sourceId: 3, sourceEndpoint: 1, targetId: 4, targetEndpoint: 1 }
        ]
    }
];
